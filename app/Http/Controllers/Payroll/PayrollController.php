...
class PayrollController extends Controller
{
    ...
    //         // ✅ Jika tidak ada data gaji sama sekali → tampilkan halaman empty
    //         if (!$gajihPokok) {
    //             return view('payroll.empty');
    ...
    public function show()
    {
        ...
        // ===== INITIAL — selalu ambil data terbaru sebagai referensi =====
