        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold leading-tight text-gray-800">
                    🗑️ Manajemen Storage Foto Laporan FO
                </h2>
        ...
        <div class="max-w-4xl mx-auto space-y-6 sm:px-6 lg:px-8">
            ...
            <div class="p-6 bg-white border-l-4 border-orange-400 rounded-lg shadow-sm">
                ...
                @if ($preview['total_photos'] > 0)
                    <form method="POST" action="{{ route('superadmin.daily-report-fo.photo-cleanup.execute') }}"
            ...
            <div class="p-6 bg-white border-l-4 border-blue-400 rounded-lg shadow-sm">
                ...
                {{-- Form Filter Range --}}
                <form method="GET" action="{{ route('superadmin.daily-report-fo.photo-cleanup.preview-range') }}"
                    class="mb-6">
                ...
                @if (isset($previewRange))
                    ...
                    @if ($previewRange['total_photos'] > 0)
                        <form method="POST"
                            action="{{ route('superadmin.daily-report-fo.photo-cleanup.execute-range') }}"
            ...
            <div class="bg-white rounded-lg shadow-sm">
                ...
                <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                    <form method="GET" action="{{ route('superadmin.daily-report-fo.photo-cleanup.index') }}"
